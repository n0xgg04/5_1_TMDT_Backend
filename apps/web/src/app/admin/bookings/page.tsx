...
import { Search, Eye, CheckCircle, XCircle, DoorOpen, DoorClosed } from "lucide-react";
...
const STATUS_OPTIONS: { value: string; label: string; tone: string }[] = [
  ...
  { value: "PAYING", label: "Đang thanh toán", tone: "blue" },
  { value: "PENDING_APPROVAL", label: "Chờ duyệt", tone: "purple" },
