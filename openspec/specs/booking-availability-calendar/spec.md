# booking-availability-calendar Specification

## Purpose
Quy định cách hệ thống công bố lịch trống/bận cho customer và lịch thuê theo phòng cho staff/admin, bảo đảm mọi bước tìm phòng, chọn ngày và duyệt vận hành đều dùng cùng một logic availability.
## Requirements
